<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SanitationDetail.aspx.cs" Inherits="BPM.Admin.Sanitation.SanitationDetail" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/SanitationDetail.js?d=<%=DateTime.Now%>"></script>
</asp:Content>
