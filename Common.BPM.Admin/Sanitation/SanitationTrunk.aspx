<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SanitationTrunk.aspx.cs" Inherits="BPM.Admin.Sanitation.SanitationTrunk" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/SanitationTrunk.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
