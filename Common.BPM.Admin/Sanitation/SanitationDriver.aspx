<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SanitationDriver.aspx.cs" Inherits="BPM.Admin.Sanitation.SanitationDriver" %>
...
<!-- 工具栏按钮 -->
    ...
    <script src="js/card.js?d=<%=DateTime.Now %>"></script>
      <script src="js/SanitationDriver.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
