<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BPM.Admin.Default" %>
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
	...
	<div  region="south" split="false" style="height: 30px; border-top:none; ">
		<div class="footer">Email:<%=ConfigurationManager.AppSettings["email"] %></div>
	</div>
