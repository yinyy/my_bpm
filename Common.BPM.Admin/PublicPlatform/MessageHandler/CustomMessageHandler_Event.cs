...
",
        ...
        public override IResponseMessageBase OnEvent_SubscribeRequest(RequestMessageEvent_Subscribe requestMessage)
        {
            ...
            #region 关注时，将openid和departmentid记录在staff中
            ...
            if (staff == null || staff.Serial==null)
            {
                if (staff == null)
                {
                    ...
                    CommonStaffBll.Instance.Insert(staff);
                }

                Article article = new Article();
                article.PicUrl = "http://course.dyzyxyydwlwsys.cc/PublicPlatform/images/register.jpg";
                article.Title = "绑定学号或教工号";
                article.Description = "只需一步，与教学质量监控系统完成绑定。";
                article.Url = "http://course.dyzyxyydwlwsys.cc/PublicPlatform/Register.aspx";
            ...
            {
                Article article = new Article();
                article.PicUrl = "http://course.dyzyxyydwlwsys.cc/PublicPlatform/images/welcome.png";
                article.Title = "欢迎回来";
                article.Description = "欢迎再次回到公众号。";
