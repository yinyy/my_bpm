<%@ Page Title="" Language="C#" MasterPageFile="~/PublicPlatform/Exam/Default.Master" AutoEventWireup="true" CodeBehind="InvigilateCalendar.aspx.cs" Inherits="BPM.Admin.PublicPlatform.Exam.InvigilateCalendar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/InvigilateCalendar.js?d=<%=DateTime.Now.Ticks %>"></script>
    <title>监考日历</title>
</asp:Content>
            ...
            <div class="page__bd" style="height: 100%;">
			    <div class="weui-tab">
				    ...
				    <div class="weui-tabbar">
					    <a href="./InvigilateCalendar.aspx" class="weui-tabbar__item weui-bar__item_on">
        ...
        <div class="weui-form-preview">
            <div class="weui-form-preview__bd">
                ...
                <div class="weui-form-preview__item">
                    ...
                    <span class="weui-form-preview__value">{{if data.Confirmed==0}}<span style="color: #ff0000;">待确认</span>{{else}}<span style="color: #0000ff;">已确认</span>{{/if}}</span>
                </div>
            </div>
            {{if data.CanConfirm && data.Confirmed==0}}
                <div class="weui-form-preview__ft">
                    <a class="weui-form-preview__btn weui-form-preview__btn_primary" href="javascript:confirmInvigilate({{data.ExamSectionItemStaffId}});">确认本次监考</a>
                </div>
            {{/if}}
        </div>
        <br />
