<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherCardIncome.aspx.cs" Inherits="BPM.Admin.Washer.WasherCardIncome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherCardIncome.js?d=<%=DateTime.Now %>"></script>
</asp:Content>