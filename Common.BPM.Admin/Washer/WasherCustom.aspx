<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherCustom.aspx.cs" Inherits="BPM.Admin.Washer.WasherCustom" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherCustom.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
