<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherCustomAdmin.aspx.cs" Inherits="BPM.Admin.Washer.WasherCustomAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--充值和消费记录-->
    <div id="win">
        <table id="tt" style="width:600px;height:480px"></table>
    </div>
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherCustomAdmin.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
