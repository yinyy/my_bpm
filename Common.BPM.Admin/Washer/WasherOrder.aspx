<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherOrder.aspx.cs" Inherits="BPM.Admin.Washer.WasherOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherOrder.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
