<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherSendNews.aspx.cs" Inherits="BPM.Admin.Washer.WasherSendNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherSendNews.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
