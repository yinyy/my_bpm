<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherCardCost.aspx.cs" Inherits="BPM.Admin.Washer.WasherCardCost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherCardCost.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
