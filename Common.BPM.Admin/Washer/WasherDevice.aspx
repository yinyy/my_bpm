<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherDevice.aspx.cs" Inherits="BPM.Admin.Washer.WasherDevice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherDevice.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
