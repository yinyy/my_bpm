<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WasherConsume.aspx.cs" Inherits="BPM.Admin.Washer.WasherConsume" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- 引入js文件 -->
    <script src="js/WasherConsume.js?d=<%=DateTime.Now %>"></script>
</asp:Content>
