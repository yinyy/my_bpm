<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LogisticsInquiry.aspx.cs" Inherits="BPM.Admin.demo.LogisticsInquiry" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/LogisticsInquiry.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
