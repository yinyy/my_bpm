<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LogisticsQuotedAll.aspx.cs" Inherits="BPM.Admin.demo.LogisticsQuotedAll" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/LogisticsQuotedAll.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
