<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="LogisticsQuotedCurrent.aspx.cs" Inherits="BPM.Admin.demo.LogisticsQuotedCurrent" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/LogisticsQuotedCurrent.js?d=<%=DateTime.Now.Ticks %>"></script>
</asp:Content>
