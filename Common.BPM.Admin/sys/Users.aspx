<%@ Page Title="" Language="C#" MasterPageFile="../Site1.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="BPM.Admin.sys.Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="js/user.js?s=134&d=<%=DateTime.Now %>"></script>
</asp:Content>
