<%@ Page Title="" Language="C#" MasterPageFile="../Site1.Master" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="BPM.Admin.sys.RoleList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="js/role.js?v=8&d=<%=DateTime.Now %>"></script>
